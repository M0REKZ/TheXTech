                                ...
                                if(CheckCollision(Player[A].Location, NPC[B].Location))
                                {
                                       ...
                                       (Player[A].Stoned && !NPC[B]->CanWalkOn))
                                    {
                                        if(HitSpot == 1)
                                        {
                                            ...
                                            if(NPC[B].Killed == 8 || (!KZNPC[NPC[B].Type].SpinKill && KZNPC[NPC[B].Type].KZENABLED) || NPC[B]->IsFish || NPC[B].Type == NPCID_SAW ||
                                    ...
                                    if(HitSpot == 1) // Player landed on a NPC
                                    {
                                                ...
                                                (!Player[A].SlideKill || NPC[B]->WontHurt)) // NPCs that cannot be walked on
                                        {
                                            ...
                                            else
                                            {
                                                ...
                                                else if(NPC[B].Killed != 10 && !NPCIsBoot(NPC[B]) && !NPCIsYoshi(NPC[B]) && !(NPC[B]->IsAShell && NPC[B].CantHurtPlayer == A)  && (!KZNPC[NPC[B].Type].KZENABLED || (KZNPC[NPC[B].Type].JumpBounce && KZNPC[NPC[B].Type].KZENABLED))) // Bounce off everything except Bonus and Piranha Plants
                                                {
